...
const useAssetFilter = () =>{
    ...
    function _thisFiltering(rows, terms) {
      ...
      const filteredRows = rows.filter((row, i) => {
        ...
        _group0 = terms.Maintained && row.requestStatus == "Maintained" ? true : _group0; //holding toggle_quicx search
        _group0 = terms.Maintained && row.requestStatus == "Maintained" ? true : _group0;
        _group0 = terms.Issued && row.requestStatus == "issued" ? true : _group0;
