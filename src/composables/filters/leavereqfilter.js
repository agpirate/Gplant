...
const useAssetFilter = () =>{
    ...
    function _thisFiltering(rows, terms) {
      ...
      const filteredRows = rows.filter((row, i) => {
        ...
        _group0 = terms.annual && row.request == "annual" ? true : _group0; //holding toggle_quicx search
        _group0 = terms.sick && row.request == "sick" ? true : _group0;
        _group0 = terms.demand && row.request == "demand" ? true : _group0;
