...
const useAssetFilter = () =>{
    ...
    function _thisFiltering(rows, terms) {
      console.error('Asset Filtering...',terms)
      ...
      const filteredRows = rows.filter((row, i) => {
        ...
        let _group3 = false;
          ...
          console.log(_group00, _group0, _group2)
        ...
        if (row.storeStatus ?? false) {
          Issued = row.storeStatus["status"] ? true: false
          //--------
        ...
        if (row.updatedAt && filterDays) {
          ...
          //--------------- filtering tech
        console.log(_group00, _group0, _group2,_dayfilter,'ppppp')
        if(_group00 && (_group0 && _group2 && _dayfilter)){
          return true
        }
          //--------------------
          return false
