...
const API_URL = process.env.API_IP_PORT+"/sale"; //const API_URL = `${import.meta.env.API_URL}/users`;
...
const _model_mainURL="/cust"
const STORE_NAME ="custStore";
...
export const custStore = defineStore(STORE_NAME, () => {
  //state
  let Datas = ref([]); //
  let status_Rows = ref('');
