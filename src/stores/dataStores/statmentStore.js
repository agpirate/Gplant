...
const API_URL = process.env.API_IP_PORT+"/finance"; //const API_URL = `${import.meta.env.API_URL}/users`;
...
const _model_mainURL="/statment"
const STORE_NAME ="statmentStore";
...
export const statmentStore = defineStore(STORE_NAME, () => {
  //state
  let Datas = ref([]); //
  let status_Rows = ref('');
