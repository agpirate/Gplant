...
const API_URL = process.env.API_IP_PORT+"/procurment"; //const API_URL = `${import.meta.env.API_URL}/users`;
...
const _model_mainURL="/rawmaterial"
const STORE_NAME ="rawmaterialStore";
...
export const rawmaterialStore = defineStore(STORE_NAME, () => {
  //state
  let Datas = ref([]); //
  let status_Rows = ref('');
