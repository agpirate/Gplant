...
<!-- {{ _this_Rows}}  -->
    ...
    <!--- Profiling...-->
    <div
    class="col-2 column rounded shadow-2 text-left items-right justify-right" v-show="selected.length > 0"
      ...
      >
        <q-card-section class="q-gutter-col-xs fit q-ma-none q-pa-none">
              ...
              <q-list bordered class="rounded-borders" style="">
                <template v-for="item of itemDetailColumns[1]" :key="item">
                  <q-item clickable v-ripple>
                    <q-item-section>
                      <q-item-label  style="text-transform: capitalize;font-weight: bold;"> {{ item }}</q-item-label>
          ...
          <q-card class="col q-py-sm column" flat>
            ...
            >
              <q-btn color="positive" dense :label="item" class="col color-primary fit" style="text-transform: capitalize;font-weight: bold;">
                <q-menu
                      ...
                      <q-item-section top>
                        ...
                        >
                          <div lines="1" v-for="(it, kk) of ite" :key="it" class="col">
                            <q-breadcrumbs class="text-light">
                              <q-breadcrumbs-el :label="kk" icon="info" style="text-transform: capitalize;font-weight: bold;"/>
                            </q-breadcrumbs>
                        ...
                        <div v-else class=" q-gutter-xs column" style="max-width:7vw">
                          <q-item-label lines="1">
                            <span class="text-weight-medium" style="text-transform: capitalize;font-weight: bold;"> {{ k }}</span>
                          </q-item-label>
                          <q-item-label >
                            <span >
                              {{ itemDetail[item][k] }}
...
let _xDisplayDefaulted=ref(['userID','Expriences','Educations','gmStatus'])
