  ...
  //----------------------------------Query Builder
  export const rOps = async function (dbModel,findBy=[],returnWat={},limits=0) {
    try {
    ...
    } catch(error) { return { status: 500, data: error};  } //DBs Connections or Configurations, modules Error
  };
  //---------------------------Reading Filtered Data
 export const rOp = async function (dbModel,findBy=[],returnWat={},limits=0,sortBy={updatedAt:-1 }) {
    try {
      return await dbModel
  ...
  export const rOrp = async function (dbModel,findBy=[],returnWat={},limits=0,sortBy={updatedAt:-1 }) {
    console.log(dbModel,'Or Fetching',findBy)
