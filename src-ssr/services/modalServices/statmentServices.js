...
import {statmentModel} from  "app/src-ssr/backendCore/models/financeModels"
//---------
var thisModel = statmentModel
...
async function createStatment(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updateStatment (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
...
export {createStatment,updateStatment}
