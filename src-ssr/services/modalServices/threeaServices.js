...
import {threeaModel} from  "app/src-ssr/backendCore/models/profileModels"
//---------
var thisModel = threeaModel
...
async function createthreea(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updatethreea (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
...
export {createthreea,updatethreea}
