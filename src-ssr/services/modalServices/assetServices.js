...
import {assetModel} from  "app/src-ssr/backendCore/models/procurmentModels"
//---------
var thisModel = assetModel
...
async function createasset(reqData,columnOperation =null,columnsubOperation =null){
    try {
      ...
      console.log(assetModel,'the asset model is ac')
      //-----------finding Record
      return await thisModel
        ...
        .then(async(modelQA) => { ///if findby is null it returns index_0 item
            ...
            return  await modelQA.save().then((modelData) => {
              console.log(modelData,'model of Asset saved')
...
async function updateasset (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
...
export {createasset,updateasset}
