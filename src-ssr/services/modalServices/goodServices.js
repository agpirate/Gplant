...
import {goodModel} from  "app/src-ssr/backendCore/models/saleModels"
//---------
var thisModel = goodModel
...
async function creategood(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updategood (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
