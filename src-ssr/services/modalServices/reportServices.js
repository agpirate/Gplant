...
import {reportModel} from  "app/src-ssr/backendCore/models/serviceModels"
//---------
var thisModel = reportModel
...
async function createreport(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updatereport (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
