...
import {planModel} from  "app/src-ssr/backendCore/models/serviceModels"
//---------
var thisModel = planModel
...
async function createplan(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updateplan (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
