...
import {supplierModel} from  "app/src-ssr/backendCore/models/procurmentModels"
//---------
var thisModel = supplierModel
...
async function createsupplier(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updatesupplier (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
