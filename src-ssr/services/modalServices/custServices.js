...
import {custModel} from  "app/src-ssr/backendCore/models/saleModels"
//---------
var thisModel = custModel
...
async function createcust(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updatecust (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
