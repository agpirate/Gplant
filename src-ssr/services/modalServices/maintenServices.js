...
import {maintenModel} from  "app/src-ssr/backendCore/models/serviceModels"
//---------
var thisModel = maintenModel
...
async function createmainten(reqData,columnOperation =null,columnsubOperation =null){
    try {
      ...
      return await thisModel
        ...
        .then(async(modelQA) => { ///if findby is null it returns index_0 item
            ...
            console.log('maitenace createing')
            ...
            console.log(modelData,'maitenace createing00')
...
async function updatemainten (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
...
export {createmainten,updatemainten}
