...
import {chatModel} from  "app/src-ssr/backendCore/models/chatModels.js"
//---------
var thisModel = chatModel
...
async function createchat(reqData,columnOperation =null,columnsubOperation =null){
    try {
...
async function updatechat (reqData,columnOperation =null,columnsubOperation =null){
    try {
      //------------Preparing finding Query
      let findBy={} 
