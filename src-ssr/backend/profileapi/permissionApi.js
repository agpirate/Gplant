...
import {documentCupdate} from "app/src-ssr/services/dBServices/documentCupdate"
...
import { rOp,rOps,dOps } from "app/src-ssr/services/dBServices/documentRead.js";//
...
router.post("/add",authenticate, async (req, res) => {
      ...
      let _defaultRole = 'creator'
      let _role_permission =await threeaModel.findOne({'group':reqData['group'] ?? _defaultRole})
...
const letRolePermissions2 =[
    {   group:'client',
       profile:{ group:'client',role:[""],capability:'22220',accstage:[1,3,4,5]},
       profileMeta:'client',
       saleit:{ group:'client',role:["likes","comments"],capability:'22220',accstage:[1,3,4,5]},
       saleitclient:{ group:'client',role:[""],capability:'22220',accstage:[1,3,4,5]},
    },
    {    group:'upgraded',
      profile:{ group:'upgraded',role:[""],capability:'22220',accstage:[1,3,4,5]},
      profileMeta:'upgraded',
      saleit:{ group:'upgraded',role:["likes","comments",'clients',],capability:'22220',accstage:[1,3,4,5]},
      saleitclient:{ group:'upgraded',role:[""],capability:'22220',accstage:[1,3,4,5]},
   },
   {   group:'creator',
   profile:{ group:'creator',role:[""],capability:'22220',accstage:[1,3,4,5]},//can do all @HisContent
   profileMeta:'creator',
   saleit:{ group:'creator',role:[""],capability:'22220',accstage:[1,2,3,4,5]}, //can do all @HisContent
   saleitclient:{ group:'creator',role:[""],capability:'22220',accstage:[1,3,4,5]},
  
  },
    {   group:'admin',
      profile:{ group:'admin',role:[""],capability:'22220',accstage:[1,3,4,5]},
      profileMeta:'admin',
      saleit:{ group:'admin',role:[""],capability:'22220',accstage:[1,2,3,4,5]},
      saleitclient:{ group:'admin',role:[""],capability:'22220',accstage:[1,3,4,5]},
